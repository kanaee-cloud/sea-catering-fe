...
const AllUserTable = ({ users, isLoading }) => {
            ...
            users.map((user) => {
              ...
              return (
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <div
                      className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium ${subscriptionIndicator.bgColor} ${subscriptionIndicator.color}`}
                    >
