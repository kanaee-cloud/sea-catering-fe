...
const UserSidebar = () => {
  ...
  const navItems = [
    { id: "dashboard", label: "Dashboard", href: "/users", icon: LayoutDashboard  },
    { id: "subscription", label: "Subscription", href: "/users/subscription", icon: Package  },
    { id: "settings", label: "Settings", href: "/users/settings", icon: Settings   },
  ];

  
  useEffect(() => {
    const path = window.location.pathname || '/users';
    setActiveRoute(path);
  }, []);
