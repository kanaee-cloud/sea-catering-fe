...
const MealPlanCard = ({ plan }) => {
  return (
    <div className="w-full max-w-xs glassmorphism rounded-3xl shadow-md overflow-hidden flex flex-col">
      <div className="p-4 flex flex-col flex-grow space-y-4">
        ...
        <div className="flex items-center justify-between text-sm mt-3 text-secondary">
          <span>
